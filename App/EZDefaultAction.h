#ifndef EZDEFAULTACTION_H
#define EZDEFAULTACTION_H
...
class EZDefaultAction : public RActionAdapter
{
public:
     enum State
     {
    ...
    EZDefaultAction(RGuiAction* pGuiAction);
    ~EZDefaultAction();
...
private:
    ...
    RObject::Id m_blockRefId;
    RObject::Id m_entityInBlockId;
    State m_state;

};

#endif // EZDEFAULTACTION_H
