...
class CASHARED_EXPORT GuillotineBinPack
{
public:
    ...
    Rect Insert(const RectSize& rcSz, bool merge, FreeRectChoiceHeuristic rectChoice, GuillotineSplitHeuristic splitMethod);
...
private:
    ...
    Rect FindPositionForNewNode(const RectSize& rcSz, FreeRectChoiceHeuristic rectChoice, int *nodeIndex);
